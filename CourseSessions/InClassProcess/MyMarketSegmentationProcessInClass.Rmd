...
1. We chose to use a manual method until the "elbow" on the stee graph (i.e. for 6 components).  

 + 1st: adventurous nature-lover
 + 2nd: passionate about boat
 + 3rd: Sees boat as a status symbol
 + 4th: Brand-sensitive
 + 5th: Price sensitive
 + 6th: Mechanic

All these factors make sense: they seem to be distinctive and not overlapping to much. 
...
1. The first person is mostly brand and stauts sensitive, he enjoys the freedom provided by the boat and he is really not price-sensitive.

Another example: the seventh person is passionate about boats and likes to repair it.

2. If we had to choose one question for each factor, we would take the one that has the highest eigenvalue for each, that is:

 + 1st (adventurous nature-lover) : Q1.21
 + 2nd (passionate about boat) : Q1.27
 + 3rd (Sees boat as a status symbol) : Q1.9
 + 4th (Brand-sensitive) : Q1.4
 + 5th (Price sensitive) : Q1.2
 + 6th (Mechanic) : Q1.11
...
#segmentation_attributes_used = c(21,27,9,4,2,11)
...
```{r setupcluster2, echo=FALSE, tidy=TRUE}
...
if (profile_with == "hclust"){
  ...
  cluster_ids <-  cluster_ids_hclShow in New WindowClear OutputExpand/Collapse Output
